...
namespace FSP.DataAccess.Constants.Financial.Income
{
    public static class GrossProfitRepositoryConstants
    {
        ...
        public const string SP_FindBYIncomeStatmentID = "GrossProfitFindByIncomeStatmentID";
        public const string SP_DeleteBYIncomeStatmentID = "GrossProfitDeleteByIncomeStatmentID";
    }
}
